...
export class ESTooltipDirective implements OnDestroy, AfterViewInit {
  ...
  private _content: TemplateRef<HTMLElement>;
  ...
  private mouseLastDelayLocation: ESTooltipMouseLocation | null;
  private mouseMoveTimeoutId: number | ReturnType<typeof setTimeout>;
   ...
   */
  private touchstartTimeout: number | ReturnType<typeof setTimeout>;
