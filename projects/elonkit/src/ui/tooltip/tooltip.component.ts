...
export class ESTooltipComponent implements OnDestroy {
  @HostBinding('style.zoom') public get zoom() {
    return this.sanitizer.bypassSecurityTrustStyle(this.visibility === 'visible' ? '1' : '');
  }

  @HostBinding('style.pointer-events') public get pointerEvents() {
    return this.sanitizer.bypassSecurityTrustStyle(this.interactive ? 'auto' : '');
  }
   ...
   */
  public showTimeoutId: number | null | ReturnType<typeof setTimeout>;
   ...
   */
  public hideTimeoutId: number | null | ReturnType<typeof setTimeout>;
