...
import { TooltipStoryBasicModule, TooltipStoryBasicComponent, TOOLTIP_STORY_BASIC_SOURCE } from './tooltip-story-basic';
import {
...
import { TooltipStoryThemingModule, TooltipStoryThemingComponent, TOOLTIP_STORY_THEMING_SOURCE } from './tooltip-story-theming';
import {
...
The tooltip provides a text label that is displayed when the user hovers over or longpress an element.
...
```ts
import { ES_TOOLTIP_DEFAULT_OPTIONS } from '@elonkit/angular/ui/tooltip';
