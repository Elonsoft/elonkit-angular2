  ...
  implements MatFormFieldControl<any[]>, ControlValueAccessor, OnInit, OnDestroy, AfterViewInit
{
  ...
  @Input() public service!: (search: string | null | undefined, options?: any[]) => Observable<any[]>;
  ...
  private _sizes: ESAutocompleteMultipleDefaultOptionsSizes;
   ...
   * @ignore
   */
  public selectionChanged$ = new BehaviorSubject(false);
